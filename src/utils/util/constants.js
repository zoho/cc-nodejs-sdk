class Constants {
    ...
    static MANDATORY_NOT_FOUND = "Mandatory key Not Found";

    static PARAMETER_DUPLICATE_ERROR = "DUPLICATE PARAMETER ERROR";

    static INVALID_CLASS_NAME = "INVALID CLASS NAME";

    static INVALID_DATA_TYPE = "INVALID DATATYPE";

    static INVALID_PARAM = "INVALID PARAM ERROR";
	
	static RESERVE_KEYWORD_USAGE_ERROR = "RESERVE KEYWORD USAGE ERROR";
	
	static PARAM_LENGTH_EXCEED_ERROR = "PARAM LENGTH EXCEED ERROR";

    static PARAM_LIMIT_EXCEED_ERROR = "PARAM LIMIT EXCEED ERROR";
    ...
    static EMPTY_CLASS_ERROR = "EMPTY CLASS NAME ERROR";
